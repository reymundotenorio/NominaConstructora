 ...
 * @author FI23
 */
public class Ver_Departamentos extends javax.swing.JFrame {

    /**
     * Creates new form Ver
     */
    public Ver_Departamentos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbbuscar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No.", "Nombre" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(txtbuscar, javax.swing.GroupLayout.DEFAULT_SIZE, 411, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String [] Titulo = {"No","Nombre Departamento"};
...
Buscar();        // TODO add your handling code here:
    ...
    private void TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaMouseClicked
        ...
        Modificar_Departamento M = new Modificar_Departamento();
        M.setVisible(true);
        M.Parametros(ID, Nombre);
        M.setV(this);
...
// TODO add your handling code here:
    ...
    public void MostrarTodo(){
        ...
        model.setRowCount(0);
            ...
            try {
                resultado = Conexion.consulta("Select * from [dbo].[Departamento]");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ver_Departamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver_Departamentos().setVisible(true);
            }
        });
    }
